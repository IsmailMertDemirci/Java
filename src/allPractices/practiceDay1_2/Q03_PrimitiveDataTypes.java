...
public class Q03_PrimitiveDataTypes {
    public static void main(String[] args) {
        ...
        //byte, short, integer, long, double, float veri tiplerinin max ve min degerlerini yazdirin
        ...
        //long, double, float veri tiplerinin max ve min degerlerini yazdiriniz
