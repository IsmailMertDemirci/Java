...
//birden fazla if else if birbirine baglanmissa son durum onemli, eger else ile bitiyorsa
//butun ihtimaller kapsaniyor demektir ama else if ile bitiyorsa kapsanmayan durumlar olabilir
