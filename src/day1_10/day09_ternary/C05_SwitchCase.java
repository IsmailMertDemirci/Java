...
public class C05_SwitchCase {
    public static void main(String[] args) {
        ...
        break yazisi gorunceye veya switch parantezine kadar devam eder!!!! devam etmesini istersek break yazilmaz

        if - else if- ... -else yapisinda oldugu gibi hicbir sarta bagli olmayanlari else ile topladigimiz gibi burada
        da default kelimesi kullanilir
         */
