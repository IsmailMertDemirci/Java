...
public class Fp05 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("ortalamaPuanlarVerilenSayidanBuyukMu(coursesList,75) = " + ortalamaPuanlarVerilenSayidanBuyukMu(coursesList, 75));
        System.out.println("kelimeKursAdlariIcindeVarMi(coursesList,\"Turkish\") = " + kelimeKursAdlariIcindeVarMi(coursesList, "Turkish"));
