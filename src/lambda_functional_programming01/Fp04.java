...
public class Fp04 {
    public static void main(String[] args) {
        System.out.println("get7den100eToplam() = " + get7den100eToplam01());
        System.out.println("get7den100eToplam() = " + get7den100eToplam02());
        System.out.println("get2den11eCarpim() = " + get2den11eCarpim());
        System.out.println("faktoriyelHesapla(5) = " + faktoriyelHesapla(5));
        System.out.println("verilenIkiSayiArasindakiCiftSayilarinToplami(2,5) = " + verilenIkiSayiArasindakiCiftSayilarinToplami(2, 5));
        System.out.println("ikiSayiArasindakiTumSayilarinToplami(11,15) = " + ikiSayiArasindakiTumSayilarinToplami(11, 15));
    ...
    public static int ikiSayiArasindakiTumSayilarinToplami(int x, int y) {
        int z = 0;
        if (x > y) {
            z = x;
            x = y;
