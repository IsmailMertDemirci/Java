...
public class C09_WhileLoop {
    public static void main(String[] args) {
       /*
        ...
        while (!sifreBasariliMi) { //basina unlem koyduk cunku true ise dongu calisir false ise calismaz
            ...
            if (kontrol == 4) { // tum kontrolllerden gecmis demektir
                ...
                sifreBasariliMi = true;//while loopun bitmesi icin true tanimladik, en basta dongu disi false idi
